...
public class Drawing
{
    ...
    public static void DrawRect(Rect rect, Color color) { DrawRect(rect, color, 1); }
    public static void DrawRect(Rect rect) { DrawRect(rect, GUI.contentColor, 1); }
    public static void DrawRect(Rect rect, Color color, float width)
    {
        ...
        DrawLine(new Vector2(rect.x + rect.width, rect.y + rect.height), new Vector2(rect.x + rect.width, rect.y), color, width);
        DrawLine(new Vector2(rect.x + rect.width, rect.y + rect.height), new Vector2(rect.x, rect.y + rect.height), color, width);
    }
}
